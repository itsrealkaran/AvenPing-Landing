        ...
        <div className="flex gap-12">
          ...
          <div className="hidden lg:block w-64 flex-shrink-0">
            <div className="sticky top-24">
              <div className="text-xs font-medium text-gray-900 mb-4 font-semibold">
                On This Page
              </div>
          ...
          <div className="flex-1 max-w-4xl">
            ...
            >
              ...
              <section id="interpretation" className="mb-12">
                ...
                <ul className="space-y-4 text-gray-700">
                  ...
                  <li>
                    ...
                    Aven Technologies Inc., 840 6 Ave SW #300, Calgary, AB T2P
                    3E5, Canada.
                  </li>
                  <li>
              ...
              <section id="data-collection" className="mb-12">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-3">
                  Google Workspace APIs Usage
                </h4>
                <p className="text-gray-700 mb-6">
                  We explicitly affirm that any data accessed through Google
                  Workspace APIs is not used to develop, improve, or train
                  generalized artificial intelligence (AI) and/or machine
                  learning (ML) models. The data is only used for the specific
                  purposes outlined in this Privacy Policy and in accordance
              ...
              <section id="contact" className="mb-12">
                ...
                <ul className="list-disc pl-6 mb-4 text-gray-700">
                  <li>
                    ...
                    <a
                      href="https://avenping.com/contact"
                      className="text-[#43A2C9] hover:underline"
                      target="_blank"
                      rel="noreferrer external nofollow noopener"
                    >
                      https://avenping.com/contact
                    </a>
                  </li>
                  <li>
                    By email:{" "}
