...
import {
  SunMedium as IconBrightnessDown,
  ...
  Table2 as IconTable,
  Volume1 as IconVolume,
  Volume2 as IconVolume2,
  Volume as IconVolume3,
...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[200vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 lg:scale-[1.5] xl:scale-[1.7] 2xl:scale-[2] 2xl:min-h-[100vh] md:py-80"
    >
      <motion.h2
        style={{
      ...
      {/* Lid */}
      <Lid src={srcs[current]} scaleX={scaleX} scaleY={scaleY} rotate={rotate} translate={translate} />
      {/* Base area */}
      <div className="relative -z-10 h-[22rem] w-[32rem] overflow-hidden rounded-2xl bg-gray-100">
        {/* above keyboard bar */}
        <div className="relative h-10 w-full">
          <div className="absolute inset-x-0 mx-auto h-4 w-[80%] bg-[#e5e7eb]" />
        </div>
        ...
        <Trackpad />
        <div className="absolute inset-x-0 bottom-0 mx-auto h-2 w-20 rounded-tl-3xl rounded-tr-3xl bg-gradient-to-t from-[#e5e7eb] to-[#f3f4f6]" />
        {showGradient && (
