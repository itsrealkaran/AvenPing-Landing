...
const Button = ({
  ...
  const baseClasses =
    "px-6 py-3 rounded-full font-medium transition-all duration-200 inline-flex items-center gap-2";
  const variants = {
    primary:
...
export default function FeaturesPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-cyan-100 via-purple-100 to-white min-h-screen">
      <Navbar />
      {/* Hero Section */}
      <section className="overflow-hidden bg-gradient-to-b from-cyan-100 via-purple-100 to-white">
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
              Discover how AvenPing's cutting-edge features can transform the
              way you manage your WhatsApp business communications. We provide
              everything you need to make smarter, data-driven decisions and
        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl md:text-6xl font-medium text-gray-900 mb-6 leading-tight">
              ...
              <br />
              <span className="text-cyan-600">WhatsApp Business</span> With
              AvenPing
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Discover the benefits that make AvenPing the perfect solution for
              businesses looking to optimize their WhatsApp communications,
              improve productivity, and drive smarter customer engagement.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="bg-gray-100 rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="bg-cyan-500 rounded-2xl p-6 text-white">
                  ...
                  <p className="text-sm opacity-90">
                    Use AI to forecast customer behavior and optimize message
                    timing
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                AvenPing's AI-driven analytics provide you with real-time,
                actionable insights to make smarter, more informed business
                decisions. Whether it's customer behavior analysis or message
                optimization, our AI technology helps you stay ahead of the
                curve.
              </p>
              ...
              <div className="space-y-6 mb-8">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Receive tailored suggestions based on your unique business situation and history.",
                  },
                ].map((item, index) => (
        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                AvenPing integrates smoothly with your existing platforms,
                allowing you to sync CRM systems, e-commerce platforms, and
                more. Consolidate your customer data in one place and streamline
                your operations.
              </p>
                ...
                {[
                  {
                    ...
                    description:
                      "Connect with top CRM platforms and e-commerce systems for seamless data flow.",
                  },
                  {
        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Understand the performance of your WhatsApp business
                communications with AvenPing's in-depth analytics. Our platform
                allows you to track, manage, and forecast customer engagement so
                you can keep your business running smoothly.
              </p>
      ...
      <section className="py-24 ">
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              AvenPing's message management system allows you to create,
              customize, and send messages in just a few clicks. Streamline your
              communication process and ensure timely responses with easy-to-use
              messaging tools.
            </p>
          </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="p-4 border border-gray-200 rounded-xl">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      <button className="px-3 py-2 bg-cyan-50 text-cyan-700 rounded-lg font-medium">
                        Welcome
                      </button>
                      <button className="px-3 py-2 bg-gray-50 text-gray-700 rounded-lg">
                        Follow-up
                      </button>
                      <button className="px-3 py-2 bg-gray-50 text-gray-700 rounded-lg">
                        Support
                  ...
                  <div className="p-4 border border-gray-200 rounded-xl">
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 text-sm text-gray-600">
                      Hi [Customer Name], welcome to our service! We're excited
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Use professional-looking, customizable templates that suit
                  your brand's identity and messaging needs.
                </p>
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Automatically schedule and send messages to customers, saving
